            ...
            <ul className="nav-list">
              ...
              <li className="nav-item">
                <Link to="/friends" className="nav-link link">
                  <div className="nav-item__icon">
                    <svg className="nav-item__icon-svg" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link to="/messenger" className="nav-link link">
                  <div className="nav-item__icon">
                    <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                      ...
                      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd"></path>
